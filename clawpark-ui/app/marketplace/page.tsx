...
export default function MarketplacePage() {
  return (
    <div className="relative h-dvh overflow-hidden bg-black text-[var(--openclaw-text)]">
      ...
      <main className="mx-auto flex h-full w-full max-w-[1160px] flex-col px-6 pb-6 pt-24 sm:pt-28">
        <section className="mx-auto flex h-full w-full max-w-[1040px] min-h-0 flex-col">
          ...
          <ScrollArea className="mt-10 min-h-0 flex-1 pr-2">
            <div className="grid grid-cols-[repeat(auto-fit,minmax(226px,1fr))] justify-items-center gap-6 pb-10 pr-2">
